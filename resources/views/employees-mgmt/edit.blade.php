                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('employee-management.update', ['id' => $employee->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('middlename') ? ' has-error' : '' }}">
                            <label for="middlename" class="col-md-4 control-label">Mobile No</label>
                        ...
                        <div class="form-group{{ $errors->has('emailId') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="middlename" type="text" class="form-control" name="emailId" value="{{ $employee->emailId }}" required>
