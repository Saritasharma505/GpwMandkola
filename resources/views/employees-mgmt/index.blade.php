...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-4">
          <a class="btn btn-primary" href="{{ route('employee-management.create') }}">Add New Teacher</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
...
<!--                <th width="8%" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Picture: activate to sort column descending" aria-sort="ascending">Picture</th>-->
                ...
                <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="HiredDate: activate to sort column ascending">Date of Joining</th>
...
<!--                  <td><img src="../{{$employee->picture }}" width="50px" height="50px"/></td>-->
                  ...
                  <td class="hidden-xs">{{$employee->middlename}}</td>
                  ...
                  <td class="hidden-xs">{{ $employee->emailId }}</td>
                  <td>
                    <form class="row" method="POST" action="{{ route('employee-management.destroy', ['id' => $employee->id]) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ route('employee-management.edit', ['id' => $employee->id],['emailId' => $employee->emailId]) }}" class="btn btn-warning col-sm-3 col-xs-5 btn-margin">
