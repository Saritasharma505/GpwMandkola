...
Route::resource('system-management/semester', 'SemesterController');
Route::post('system-management/semesters/search', 'SemesterController@search')->name('semester.search');
...
Route::resource('task-management', 'Upload_Notes_Controller');
Route::post('task-management/search', 'Upload_Notes_Controller@search')->name('task-management.search');
